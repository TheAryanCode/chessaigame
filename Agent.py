...
import ChessEngine as p

class MesaChessAgent(Agent):
    def __init__(self, unique_id, model):
        ...
        self.current_castling_rights = p.CastleRights(True, True, True, True)
        self.castle_rights_log = [p.CastleRights(self.current_castling_rights.wks, self.current_castling_rights.bks,self.current_castling_rights.wqs, self.current_castling_rights.bqs)]
        pass
