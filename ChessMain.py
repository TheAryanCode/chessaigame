...
from Agent import MesaChessAgent
...
def loadImages():
    ...
    for piece in pieces:
        IMAGES[piece] = p.transform.scale(p.image.load("C:\\Users\\V R N S Nikhil\\OneDrive\\Desktop\\New folder\\chess\images\\" + piece + ".png"), (SQUARE_SIZE, SQUARE_SIZE))
    ...
    while running:
        ...
        if not game_over and not human_turn and not move_undone:
            if not ai_thinking:
                ai_thinking = True
                return_queue = Queue()
                make_move=MesaChessAgent(game_state,drawPieces)  # used to pass data between threads
